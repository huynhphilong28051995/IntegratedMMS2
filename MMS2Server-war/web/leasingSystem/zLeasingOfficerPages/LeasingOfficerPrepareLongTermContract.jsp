<%-- 
    Document   : LeasingOfficerPrepareLongTermContract
    Created on : Sep 27, 2015, 8:01:08 AM
    Author     : PhiLong
--%>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    <div class="container">
                        <form action="ComposeLongTermApplicationRequest" method="GET">
                            <div class="form_group">
                                <label>Contract start date</label>
                                <input type="text" id="datepickerStart" name="contractStart"/>
                                <label>Contract end date</label>
                                <input type="text" id="datepickerEnd" name="contractEnd"/>
                            </div>
