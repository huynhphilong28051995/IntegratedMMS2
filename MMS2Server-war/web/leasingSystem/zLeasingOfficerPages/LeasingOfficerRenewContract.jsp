<%-- 
    Document   : LeasingOfficerRenewContract
    Created on : Oct 13, 2015, 11:10:51 PM
    Author     : PhiLong
--%>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    %>
                    <form action="ProposeContractRenew">
                        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="datepickerStart" name="newStart"/></td>
                            </tr>
                            <tr>
                                <th>New contract end</th>
                                <td><input type="text" id="datepickerEnd" name="newEnd"/></td>
                            </tr>
                            <tr>
                                <th>New contract rate</th>
                                <td><input type="number" name="newRate"></td>
                            </tr>
                            <tr>
                                <th>New contract deposit</th>
                                <td><input type="number" name="newDeposit"></td>
                            </tr>
                            <tr>
                                <th>New contract description</th>
                                <td>
                                    <div class="form-group">
                                        <textarea  name="newDescription" rows="10" cols="180" placeholder="Enter tenant description"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <textarea  name="requestDescription" rows="10" cols="180" placeholder="Enter tenant description"></textarea>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        <button class="btn-default" onclick="return confirm('Proceed proposing contract renewal?')">Proceed</button>
                    </form>
                    <script>
                        $(function () {
