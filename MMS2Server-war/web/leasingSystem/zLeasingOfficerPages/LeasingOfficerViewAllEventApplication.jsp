<%-- 
    Document   : LeasingManagerViewAllEventApplication
    Created on : Oct 11, 2015, 8:49:01 PM
    Author     : PhiLong
--%>
...
<html>
    ...
    <body class="page-header-menu-fixed">
            ...
            <div class="page-head">
                <div class="container">
                    ...
                    <div class="page-title">  
                        <h1>Event Application Listing </h1>
                    </div>
                    <!-- END PAGE TITLE -->
                ...
                <div class="container">
                    ...
                    <form>
                        <table id="leasingRequestTable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <%
                                    ArrayList<EventEntity> eventList = (ArrayList<EventEntity>) request.getAttribute("eventApplicationList");
                                ...
                                <tr>
                                    ...
                                    <td><%=unitString%></td>
                                    <td>
                                        <a onclick="return confirm('Proceed accepting this application?')"
                                           href="AcceptEventApplication?eventId=<%=eventId%>">
                                            ACCEPT</a>   
                                    </td>
                                </tr>
                                <%
        ...
        <%
            if (request.getAttribute("acceptEventStatus") != null) {
                String acceptEventStatus = (String) request.getAttribute("acceptEventStatus");
                if (acceptEventStatus.contains("Unsuccessful")) {
        %>
        <script language="javascript">
            $(document).ready(function () {
                // show when page load
                toastr.error('<%=acceptEventStatus%>');
            });
        </script>
        <%
        } else {
        ...
        <script language="javascript">
            $(document).ready(function () {
                // show when page load
                toastr.success('<%=acceptEventStatus%>');
            });
        </script>
        <%
                }
