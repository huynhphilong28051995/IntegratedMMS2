<%-- 
    Document   : PublicApplicationPortalFillInformationLongTerm
    Created on : Sep 26, 2015, 8:28:12 PM
    Author     : PhiLong
--%>
...
<html>
    ...
    <body class="page-header-menu-fixed">
       ...
       <div class="container">
            <form action="ConfirmLongTermApplicantInformation" method="GET">
                ...
                <div class="form_group">
                    ...
                    <br/>
                    <select name="applicantBusinessType"> <%
                       ArrayList<String> businessTypeList = (ArrayList)request.getAttribute("businessTypeList");
                ...
                <div class="form-group">
                    <label for="applicantDescription">Applicant description :</label><br/>
                    <textarea resize="none" name="applicantDescription" rows="10" cols="180" placeholder="Enter applicant description"></textarea>
                </div>
                <div class="form-group">
                    <label for="applicantAddress">Applicant address :</label>
                    <input type="text" required="required" class="form-control"
                           id="applicantAddress" name="applicantAddress" placeholder="Enter applicant address">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="applicantBidRate">Enter your bidding rate/month :</label>
                    <input type="number" required="required" class="form-control"
                           id="applicantBidRate" name="applicantBidRate" placeholder="Enter your bid">
                </div>
