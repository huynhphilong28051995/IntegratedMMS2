<%-- 
    Document   : PublicApplicationPortalChooseMall
    Created on : Oct 5, 2015, 11:12:00 PM
    Author     : PhiLong
--%>
...
<html>
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Merlion Leasing System | Public portal choose mall</title>
        ...
        <div class="page-header">
            ...
            <div class="page-header-top">
                <div class="container">
                    <!-- BEGIN LOGO -->
                    <div class="page-logo">
                        <a href=""><img src="../assets/admin/interface/img/logo_small.png" alt="logo" class="logo-default"></a>
                    </div>
                    <!-- END LOGO -->
            ...
            <div class="page-head">
                <div class="container">
                    ...
                    <div class="page-title">  
                        <h1>Below is the list of malls with opening space. Please choose one </h1>
                    </div>
                    <!-- END PAGE TITLE -->
                        ...
                        <select name="mallName" required="require">
                            <%
                                ...
                                for (int i = 0; i < mallNameList.size(); i++) {
                                    String mallName = mallNameList.get(i);
                            %>
                            <option value="<%=mallName%>"><%=mallName%></option>
                            <%
                                }
                            %>
                        </select><br>
