<%-- 
    Document   : leasingSystemReroute
    Created on : Sep 29, 2015, 5:17:48 AM
    Author     : PhiLong
--%>
...
<html>
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Merlion Leasing System | Add store unit(s)</title>
    ...
    <body class="page-header-menu-fixed">
            ...
            <div class="page-head">
                <div class="container">
                    ...
                    <div class="page-title">  
                        <h1>Click on link below to be redirected to leasing system </h1>
                    </div>
                    <!-- END PAGE TITLE -->
        ...
        <%
            ...
            String staffFirstName = (String)request.getSession().getAttribute("staffFirstName");
            ...
            System.out.println("LeasingSystemReroute : "+staffPosition +" "+mallName+" "+staffFirstName);
