<%-- 
    Document   : indexPushCartDeclare
    Created on : Sep 20, 2015, 11:49:12 AM
    Author     : PhiLong
--%>
...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>Merlion Leasing System | Add push cart unit</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    %>
                    <form action="AddNumOfPushCartPerLevel" method="GET">
                        <%
                            for (int i = 1; i <= numOfLevel; i++) {
                        %>
                        <div class="form-group">
                            <label for="numOfPushCartToAddLevel<%=i%>">Number of pushcart to add in level <%=i%></label>
                            <input type="number" min="0" step="1" default="0" required="required" class="form-control"
                                   id="numOfPushCartToAddLevel<%=i%>" name="numOfPushCartToAddLevel<%=i%>" 
                                   >
                        </div>
                        <script>
                document.getElementById("numOfPushCartToAddLevel<%=i%>").defaultValue = "0";
                        </script>
                        <%
                            }
                        %>
