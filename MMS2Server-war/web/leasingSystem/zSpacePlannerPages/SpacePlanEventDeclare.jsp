<%-- 
    Document   : indexEventDeclare
    Created on : Sep 22, 2015, 11:43:47 AM
    Author     : PhiLong
--%>
...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>Merlion Leasing System | Add event unit(s)</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    %>
                    <form action="AddNumOfEventPerLevel" method="GET">
                        <%
                            for (int i = 1; i <= numOfLevel; i++) {
                        %>
                        <div class="form-group">
                            <label for="numOfEventToAddLevel<%=i%>">Number of kiosk to add in level <%=i%></label>
                            <input type="number" min="0" step="1" default="0" required="required" class="form-control"
                                   id="numOfEventToAddLevel<%=i%>" name="numOfEventToAddLevel<%=i%>" 
                                   >
                        </div>
                        <script>
                document.getElementById("numOfEventToAddLevel<%=i%>").defaultValue = "0";
                        </script>
                        <%
                            }
                        %>
