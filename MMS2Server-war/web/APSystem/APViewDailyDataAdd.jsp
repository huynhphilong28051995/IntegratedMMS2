<%-- 
    Document   : APViewDailyDataAdd
    Created on : 8 Nov, 2015, 10:36:37 PM
    Author     : khushnaz
--%>
...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>Merlion APS System | List Daily Data</title>
            ...
            <div class="page-head">
                <div class="container">
                    ...
                    <div class="page-title">  
                        <h1>List All Campaign Daily Data</h1>
                    </div>
                    <!-- END PAGE TITLE -->
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Rating</th>
                                    <th>Date Record</th>
                                    <th>Referenced Campaign Name</th>
                                    <th></th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${requestScope.list}" var="dailyData">
                                    <tr class="success">
                                <form action="APSControllerServlet" method="POST">
                                    <td>${dailyData.description}</td>
                                    <td>${dailyData.rating}</td>
                                    <td>${dailyData.dateRecord}</td>
                                    <td>${dailyData.campaign.campaignName}</td>

                                    <input type="hidden" name="dailyDataId" value="${dailyData.dailyDataId}" />
                                        <script>
                                            function deleteD() {
                                    ...
                                    <td><input type="submit" name="action" value="Delete Daily Data" onclick=" return deleteD()"/></td>
                                    <td><input type="submit" name="action" value="Edit Daily Data" onclick=" return editD()" /></td>                                </form>
                                </tr>
                            </c:forEach>
                        </table>
