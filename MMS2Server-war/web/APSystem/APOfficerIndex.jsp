<%-- 
    Document   : APOfficerIndex
    Created on : 7 Nov, 2015, 3:19:19 PM
    Author     : khushnaz
--%>
...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>Merlion APS System | Officer Page</title>
                ...
                <div class="container">
                    ...
                    <div class="hor-menu ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="">
                                <form action="APSControllerServlet" method="Post" name="PastOff">
                                    <input type="hidden" name="action" value="ViewPastCampaignsO" />
                                </form>
                                <a href="javascript:PastOff.submit()">View Past Campaigns</a>
                            </li>
