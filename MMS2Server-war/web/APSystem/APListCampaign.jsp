                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <form action="APSControllerServlet" method="POST">
                                    ...
                                    <td><input type="submit" name="action" value="Delete Campaign" onclick="return deleteC()"/></td>
                                    <td><input type="submit" name="action" value="Edit Campaign" onclick="return editC()"/></td>                                    
                                </form>
                                </tr>
                            </c:forEach>
                        </table>
