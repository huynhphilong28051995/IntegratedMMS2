<%--
    Document   : APAddCampaign
    Created on : 15 Oct, 2015, 7:50:20 PM
    Author     : khushnaz
--%>
...
<html>
    <head>
        <title>Merlion APS System | Add Campaign</title>
            ...
            <form action="APSControllerServlet" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required="required" class="form-control"
                           id="campaignName" name="campaignName" placeholder="Enter campaign name eg 500 loyalty points, discount">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" required="required" class="form-control"
                           id="target" name="target" placeholder="Enter target">
                </div>

                <input type="hidden" name="action" value="addCampaign" />
                <input type="submit" class="btn btn-success" value="Add Campaign" onclick="msgAdd()"/>
