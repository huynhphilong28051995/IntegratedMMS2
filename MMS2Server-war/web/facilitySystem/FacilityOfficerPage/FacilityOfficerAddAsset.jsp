        ...
        <div class="page-container">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    <form action="saveAsset" method="GET">
                        <table>
                            <tr>
                                <td>Name:</td>
                                <td><input type="text" name="assetName" required="required"/></td>
                            </tr>
                            <tr>
                                <td>Quantity:</td>
                                <td><input type="number" name="assetQuantity" min="1" max="200" required="required"/></td>
                            </tr>
                            <tr>
                                <td>Condition:</td>
                                <td><select name="assetCondition" required="required">
                            ...
                            <tr>
                                <td>Cost:</td>
                                <td><input type="number" name="assetCost" step="any" required="required"/></td>
                            </tr>
                        </table>
                        <br/>
