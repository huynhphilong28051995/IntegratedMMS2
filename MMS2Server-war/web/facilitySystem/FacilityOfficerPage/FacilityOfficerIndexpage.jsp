<%-- 
    Document   : FacilityOfficerIndex
    Created on : Oct 2, 2015, 1:58:15 PM
    Author     : linjiao_Zoe
--%>
...
<html>
    <head>
        <title>Merlion Facility Management System | Index Page</title>
    ...
    <body class="page-header-menu-fixed">
            ...
            <div class="page-head">
                <div class="container">
                    ...
                    <div class="page-title">  
                        <h1>Facilities Management System - Officer</h1>
                    </div>
                    <!-- END PAGE TITLE -->
                </div>
            </div>
        ...
        <script language="javascript">
            $(document).ready(function () {
                // show when page load
                toastr.success('<%=addServiceRequestStatus%>');
            });
        </script>
        <%
            }
