<%-- 
    Document   : FacilityOfficerListServiceRequest
    Created on : Oct 3, 2015, 11:18:22 AM
    Author     : linjiao_Zoe
--%>
<%@page import="Entity.ServiceEntity"%>
...
<html>
    <head>
        <title>Merlion Facility Management System | List Service Request</title>
    ...
    <body class="page-header-menu-fixed">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    <table border="3">
                        ...
                        <%
                            ArrayList services = (ArrayList) request.getAttribute("data");
                        ...
                        <tr>
                            ...
                            <td><%=servicingDate%></td>           
                            <td>
                                <a onclick="return confirm('Are you sure you want to delete this service request?')" 
                                   href="deleteServiceRequest?serviceId=<%=Id%>">&nbsp;&nbsp;&nbsp;Delete</a>
                                <a href="editServiceRequest?serviceId=<%=Id%>">&nbsp;&nbsp;&nbsp;Edit</a>
                            </td>
                        </tr>           
                        <%
                            }
        ...
        <%
            if (request.getAttribute("editServiceRequestStatus") != null) {
                String editServiceRequestStatus = (String) request.getAttribute("editServiceRequestStatus");
        %>
        <script language="javascript">
            $(document).ready(function () {
                // show when page load
                toastr.success('<%=editServiceRequestStatus%>');
            });
        </script>
        <%
            }
        ...
        <%
            if (request.getAttribute("deleteServiceRequestStatus") != null) {
                String deleteServiceRequestStatus = (String) request.getAttribute("deleteServiceRequestStatus");
        %>
        <script language="javascript">
            $(document).ready(function () {
                // show when page load
                toastr.success('<%=deleteServiceRequestStatus%>');
            });
        </script>
        <%
            }
