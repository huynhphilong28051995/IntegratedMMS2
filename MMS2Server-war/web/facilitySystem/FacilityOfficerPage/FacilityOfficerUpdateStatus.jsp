...
<html>
    <head>
        <title>Merlion Facility Management System | Update Status</title>
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-white-sharp ">Edit Feedback Status</span>
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="changeStatus" method="GET" class="form-horizontal form-bordered form-row-stripped">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">                                         
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4"><%=mallName%></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">New Status<span class="required">* </span>  </label>
                                                <div class="col-md-4">
                                                    <select name="status" id="country_list" required="required" class="form-control select2me">
                                                        <option value="<%=status%>" selected="selected">Remind as <%=status%></option>
