...
<html>
    <head>
        <title>Merlion Facility Management System | Edit Contractor</title>
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-white-sharp ">Edit Existing Contractor By ID</span>
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="changeContractor" method="GET" class="form-horizontal form-bordered form-row-stripped">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">  
                                            <%
                                                ...
                                                String start = contractor.getContractStartDate().toString().substring(0, 10);
                                                String end = contractor.getContractEndDate().toString().substring(0, 10);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="text" name="contractorName" value="<%=name%>" style="width: 250px;" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="serviceType" id="country_list" class="form-control select2me">
                                                        <option value="<%=service%>" selected="selected">Remain as <%=service%></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="text" id="datepickerContractStartDate" name="contractStartDate" value=<%=start%> style="width: 130px;" class="form-control"/>
                                                        <script>
                                                            $(function () {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="text" id="datepickerContractEndDate" name="contractEndDate" value=<%=end%> style="width: 130px;" class="form-control"/>
                                                        <script>
                                                            $(function () {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="text" name="contractorTel" value="<%=contact%>" style="width: 250px;" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="email" name="contractorEmail" value="<%=email%>" style="width: 250px;" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
