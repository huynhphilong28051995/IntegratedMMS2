<%-- 
    Document   : FacilityManagerIndexPage
    Created on : Oct 13, 2015, 11:34:49 AM
    Author     : linjiao_Zoe
--%>
...
<html>
    <head>
        <title>Merlion Facility Management System | Index Page BULLSHIT</title>
            ...
            <div class="page-head">
                <div class="container">
                    ...
                    <div class="page-title">  
                        <h1>Facilities Management System - Manager</h1>
                    </div>
                    <!-- END PAGE TITLE -->
                </div>
            </div>
