...
<html lang="en">
   <head>
      <meta charset="utf-8"/>
      <title>Merlion Mall Asia | Manage Level</title>
      <% 
        if ("del".equals(query)) { 
      %> 
      <META HTTP-EQUIV="Refresh" CONTENT="2;URL=manageLevel">
      <% } %>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Manage MMA Level(s)</span>
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
										<form method="post" action="addLevel" method="post" action="adminHome">
											<button class="btn green">
											Add New Level <i class="fa fa-plus"></i>
											</button>
										</form>
										</div>
									</div>
							...
							<tbody>
                                                            <% 
                                                            ArrayList levelList = (ArrayList)request.getAttribute("levelList");
                                                            int count = 0;
...
if (currQuery.equals(query)) { %>class="fa fa-check-square-o" <% } else { %> class="fa fa-square-o" <% } %>></i></a>
									...
									Delete </a>
                                                        ...
                                                        <br /><div class="label label-info">Info: To delete a level, click on the line item <i class="fa fa-check-square-o"></i>
	...
	<!-- END PAGE CONTENT -->
      ...
      <script language="javascript">
        $(document).ready(function() {
            toastr.success('Level Successfully Deleted!');
        });
      </script>
      <% } %>
      <!-- END JAVASCRIPTS -->
