...
<html lang="en">
   <head>
      <meta charset="utf-8"/>
      <title>Merlion Mall Asia | Manage Position</title>
      <% 
        if ("del".equals(query)) { 
      %> 
      <META HTTP-EQUIV="Refresh" CONTENT="2;URL=managePosition">
      <% } %>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Manage MMA Position(s)</span>
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
										<form method="post" action="addPosition" method="post" action="adminHome">
											<button class="btn green">
											Add New Position <i class="fa fa-plus"></i>
											</button>
										</form>
										</div>
									</div>
							...
							<tr>
								...
								<td>
                                                                         <% st.nextToken(); //Skipping positionID%>
									 <%= st.nextToken()%>
								</td>
								<td>
...
if (currQuery.equals(query)) { %>class="fa fa-check-square-o" <% } else { %> class="fa fa-square-o" <% } %>></i></a>
									...
									Delete </a>
                                                        ...
                                                        <br /><div class="label label-info">Info: To delete a position, click on the line item <i class="fa fa-check-square-o"></i>
