...
<html lang="en">
   <head>
      <meta charset="utf-8"/>
      <title>Merlion Mall Asia | Manage Employee</title>
      <% 
        if ("del".equals(query)) { 
      %> 
      <META HTTP-EQUIV="Refresh" CONTENT="2;URL=manageEmployee">
      <% } %>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Manage MMA Employee(s)</span>
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
										<form method="post" action="addEmployee" method="post" action="adminHome">
									 ...
									 Delete&nbsp;
                                                        ...
                                                        <tbody>
                                                            ...
                                                            for (Object o: employeeList) {
                                                                String employee = (String)o;
                                                                StringTokenizer st = new StringTokenizer(employee, "#");
                                                        %>
							<tr>
                                                                <td>
									 <%= st.nextToken()%>
								...
								<td>
                                                                        <% String endContract = st.nextToken();
                                                                        String month = "";
                                                                        Date now = new Date();
                                                                        ...
                                                                        //Get Month
                                                                        //System.out.println(endContract.substring(4,7));
                                                                        month = endContract.substring(4,7);
                                                                        if(month.equals("Jan")) {
                                                                            month = "01";
                                                                        }
                                                                        if(month.equals("Feb")) {
                                                                        ...
                                                                        //Get Day
                                                                        String day = endContract.substring(8,10);
                                                                        //System.out.println(endContract.substring(8,10));
                                                                        //Get Year
                                                                        String year = endContract.substring(24,28);
                                                                        //System.out.println(endContract.substring(24,27));
                                                                        
                                                                        String endContract1 = day + "/" + month + "/" + year;
                                                                        //System.out.println(endContract1);
                                                                        Date endDate = sdf.parse(endContract1);
                                                                        //System.out.println(endDate);
                                                                        //sdf.format(endContract1);
                                                                        
                                                                        %>

                                                                        <% if (now.before(endDate)) { %>
                                                                         <span class="label label-sm label-success">Active</span>
                                                                         <% } else { %> <span class="label label-sm label-info">Inactive</span> <% } %>
...
if (currQuery.equals(query)) { %>class="fa fa-check-square-o" <% } else { %> class="fa fa-square-o" <% } %>></i></a>
									...
									Delete </a>
                                                        ...
                                                        <br /><div class="label label-info">Info: To delete an employee, click on the line item <i class="fa fa-check-square-o"></i>
                                                         and followed by "Delete"</div>
                                                        <br /><div class="label label-info">Info: To view more information, click on edit.</div>
