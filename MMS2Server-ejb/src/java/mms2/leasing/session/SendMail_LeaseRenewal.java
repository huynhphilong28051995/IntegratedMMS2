 ...
 * @author PhiLong
 */
public class SendMail_LeaseRenewal {
    private String to;
    private String from;
    ...
    //Send Mail Function
    public int sendMail(TenantEntity tenant){
        ...
        try
        {
            Properties props = System.getProperties();
              ...
              subject = "Merlion Mall Asia Lease Renewal Reminder";
              message = "Hi, " +tenantName+" !\n\n"+
                      "This mail is generated from "+mallName+"'s leasing system\n"
                      + "Your contract would be expired soon\n\n"
                      + "If you want to renew your contract, please contact our staff\n\n"                     + "Thank you and have a pleasent stay at MMA\n"
